...
contract ScamHunterDex {
    ...
    function deposit() public payable returns (uint256 tokensDeposited) {
        ...
        tokenDeposit = (msg.value * token_reserve) / eth_reserve + 1;
        liquidityMinted = (msg.value * totalLiquidity) / eth_reserve;
    ...
    function withdraw(
        ...
        ethWithdrawn = (amount * eth_reserve) / totalLiquidity;
        tokenAmount = (amount * token_reserve) / totalLiquidity;
